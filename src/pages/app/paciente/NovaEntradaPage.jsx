...
export default function NovaEntradaPage() {
  ...
  const [perda, setPerda] = useState('sem_perda')
  ...
  return (
    ...
    >
      <h1 className="text-lg font-semibold" style={{ color: colors.secondary }}>Nova entrada</h1>
      ...
      <div>
        <label className="block text-sm font-medium mb-2">Volume urinado (se aplicável)</label>
        <AtalhosVolume value={volumeUrinadoMl} onChange={setVolumeUrinadoMl} placeholder="ml (opcional)" />
      </div>
      ...
      <div>
        <label className="block text-sm font-medium mb-2">Perda involuntária de urina</label>
        <SeletorSeveridade value={perda} onChange={setPerda} incluirSemPerda />
      </div>

      {perda !== 'sem_perda' && (
        <div>
          <label className="block text-sm font-medium mb-2">Atividade na ocasião da perda</label>
          <SeletorAtividade
